# handlers/idea_handler.py - FIXED: Robust filters and proper FSM state management
import logging
...
# FIXED: Robust filter for idea button - handles all variations including case-insensitive
...
async def start_idea_flow(message: types.Message, state: FSMContext):
    """Start idea submission flow - FIXED: Robust filter for all variations"""
    try:
