# handlers/test_handler.py - FIXED: Robust filters and proper FSM state management
import logging
...
# FIXED: Robust filter for test button - handles "Пройти опрос", "Пройти тест", and all variations
...
async def start_test_flow(message: types.Message, state: FSMContext):
    """Start daily test flow - FIXED: Robust filter for all button variations"""
...
# FIXED: Removed debug handler - moved to global handler in main.py
