# handlers/problem_handler.py - FIXED: Robust filters and proper FSM state management
import logging
...
# FIXED: Robust filter for problem button - handles all variations including case-insensitive
...
async def start_problem_flow(message: types.Message, state: FSMContext):
    """Start problem submission flow - FIXED: Robust filter for all variations"""
    try:
