# main.py - COMPLETE FIX: Correct imports, router order, and global debug handler
import asyncio
import logging
import sys
from aiogram import Dispatcher, Bot, types  # FIXED: Added types import to prevent NameError
...
async def main():
    """Main bot function - COMPLETE FIX: Correct architecture"""
    try:
        logger.info("=" * 50)
